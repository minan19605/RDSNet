...
class RdsnetHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(RdsnetHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def loss(self,
        ...
        for cls_score, bbox_pred, obj_rep, pos_ind, anchor, bbox_target, mask_target, img_meta in zip(
            ...
            pos_bbox_preds.append(delta2bbox(anchor[pos_ind], bbox_pred[pos_ind],
                                             means=self.bbox_coder.means, stds=self.bbox_coder.stds,
    ...
    @force_fp32(apply_to=('cls_scores', 'bbox_preds'))
    def get_bboxes(self, cls_scores, bbox_preds, obj_reps, img_metas, cfg=None, rescale=False):
        ...
        for img_id in range(len(img_metas)):
            ...
            proposals = self._get_bboxes_single(cls_score_list, bbox_pred_list, obj_reps_list,
